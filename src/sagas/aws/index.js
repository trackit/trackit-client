...
import { getEC2ReportSaga, getRDSReportSaga, getECReportSaga } from './resourcesSaga';
...
export function* watchGetECReport() {
  yield takeLatest(Constants.AWS_RESOURCES_GET_EC, getECReportSaga);
}
